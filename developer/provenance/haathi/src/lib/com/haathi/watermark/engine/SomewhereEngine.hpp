...
Header
******************************************************************************/
// $Header: //MyDataDepot/Projects/provenance-autoType2/haathi/src/lib/com/haathi/watermark/engine/SomewhereEngine.hpp#3 $
/******************************************************************************
Guard
******************************************************************************/
#ifndef COM__HAATHI__WATERMARK__ENGINE__SOMEWHERE_ENGINE_HPP
#	define COM__HAATHI__WATERMARK__ENGINE__SOMEWHERE_ENGINE_HPP
/******************************************************************************
Include
******************************************************************************/
...
Class
******************************************************************************/
class SomewhereEngine: public WatermarkEngine {
	protected:
		typedef void (SomewhereEngine::*TextAction)(com::haathi::document::SmartCursor& smartCursor);
		...
		void watermarkRun(com::haathi::text::Range range, rtl::OUString documentState);
		...
		void underwatermark(com::haathi::document::SmartCursor& smartCursor, int channel);
	...
	public:
		SomewhereEngine(Reference<com::sun::star::frame::XController> xController,
