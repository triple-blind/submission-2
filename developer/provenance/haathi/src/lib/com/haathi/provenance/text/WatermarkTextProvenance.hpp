...
Header
******************************************************************************/
// $Header: //MyDataDepot/Projects/provenance-autoType2/haathi/src/lib/com/haathi/provenance/text/WatermarkTextProvenance.hpp#1 $
/******************************************************************************
Guard
******************************************************************************/
#ifndef COM__HAATHI__PROVENANCE__TEXT__WATERMARK_TEXT_PROVENANCE_H
#	define COM__HAATHI__PROVENANCE__TEXT__WATERMARK_TEXT_PROVENANCE_H
/******************************************************************************
Include
******************************************************************************/
...
******************************************************************************/
class WatermarkTextProvenance: public ProvenanceTextEvent {
	...
	public:
		WatermarkTextProvenance(int offset, OUString before, OUString after);
		//virtual ~WatermarkTextProvenance();
		WatermarkTextProvenance& operator=(const WatermarkTextProvenance& other);
		WatermarkTextProvenance(const WatermarkTextProvenance& other);
