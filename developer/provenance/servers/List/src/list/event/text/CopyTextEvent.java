/* ***************************************************************************
$Header: //MyDataDepot/Projects/provenance-autoType2/servers/List/src/list/event/text/CopyTextEvent.java#1 $
*****************************************************************************
Package
****************************************************************************/
...
Class
****************************************************************************/
public class CopyTextEvent extends ProvenanceEvent
{
	protected String eventLocation;	
	protected ArrayList<String> eventData;
	
	public CopyTextEvent(String className, String eventUser, Document document, XPath xPath)
	{
