/* ***************************************************************************
$Header: //MyDataDepot/Projects/provenance-autoType2/servers/List/src/list/event/text/DeleteTextEvent.java#1 $
*****************************************************************************
Package
****************************************************************************/
...
Class
****************************************************************************/
public class DeleteTextEvent extends ProvenanceEvent
{
	protected String eventLocation;
	protected ArrayList<String> eventData;
	
	public DeleteTextEvent(String className, String eventUser, Document document, XPath xPath)
	{
