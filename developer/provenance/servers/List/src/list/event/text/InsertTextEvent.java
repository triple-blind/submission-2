/* ***************************************************************************
$Header: //MyDataDepot/Projects/provenance-autoType2/servers/List/src/list/event/text/InsertTextEvent.java#1 $
*****************************************************************************
Package
****************************************************************************/
...
Class
****************************************************************************/
public class InsertTextEvent extends ProvenanceEvent
{
	protected String eventLocation;
	protected ArrayList<String> eventData;
	
	public InsertTextEvent(String className, String eventUser, Document document, XPath xPath)
	{
