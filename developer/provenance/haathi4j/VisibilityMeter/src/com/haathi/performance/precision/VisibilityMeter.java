...
/* ***************************************************************************
 Class
 ****************************************************************************/
public class VisibilityMeter extends SharedMeter {
	...
	public VisibilityMeter(String[] args) {
		super(args);
		this.args = args;
	...
	protected void printResults(PrintStream printStream, int vis) {
		printStream.println();		
